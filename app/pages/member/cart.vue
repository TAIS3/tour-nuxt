      ...
      <div class="row">
        <div class="col-lg-8">
          <div v-if="cartItems.length === 0" class="text-center py-5 bg-white rounded shadow-sm">
            ...
            <p class="mt-3 text-muted">{{ t('member.cartEmpty') || 'Your cart is empty' }}</p>
          ...
          <div class="card shadow-sm border-0 sticky-top" style="top: 100px; z-index: 1;">
            <div class="card-body p-4">
              ...
              <div class="d-flex justify-content-between mb-3">
                <span class="text-muted">{{ t('member.cartSubtotal') || 'Subtotal' }}</span>
...
const handleCheckout = () => {
  swal(t('member.checkoutSuccess') || 'Proceeding to payment...', { icon: 'success' })
